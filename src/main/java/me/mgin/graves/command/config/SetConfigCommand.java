...
public class SetConfigCommand {
     ...
     */
    private static void executeOnServer(CommandContext<ServerCommandSource> context, CommandContextData data) throws CommandSyntaxException {
     ...
     * @param data    CommandContextData
     */
    private static void executeOnClient(CommandContext<ServerCommandSource> context, CommandContextData data) throws CommandSyntaxException {
        ServerCommandSource source = context.getSource();
